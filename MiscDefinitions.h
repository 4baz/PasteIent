...
public:
	...
	//-----------------------------------------------------------------------------
	void Init(const Vector &xAxis, const Vector &yAxis, const Vector &zAxis, const Vector &vekOrigin)
	{
		m_flMatVal[0][0] = xAxis.x;		m_flMatVal[0][1] = yAxis.x;		m_flMatVal[0][2] = zAxis.x;		m_flMatVal[0][3] = vekOrigin.x;
		m_flMatVal[1][0] = xAxis.y;		m_flMatVal[1][1] = yAxis.y;		m_flMatVal[1][2] = zAxis.y;		m_flMatVal[1][3] = vekOrigin.y;
		m_flMatVal[2][0] = xAxis.z;		m_flMatVal[2][1] = yAxis.z;		m_flMatVal[2][2] = zAxis.z;		m_flMatVal[2][3] = vekOrigin.z;
	}
	...
	// the Y axis = left, and the Z axis = up
	//-----------------------------------------------------------------------------
	matrix3x4_t(const Vector &xAxis, const Vector &yAxis, const Vector &zAxis, const Vector &vekOrigin)
	{
