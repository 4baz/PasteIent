...
public:
	...
	CPNETVAR_FUNC(AttributeContainer*, m_AttributeManager, 0xCFFCE089); //// if not working please delete
																		// ----------------------------------------------//
...
#define TIME_TO_TICKS( dt )		( (int)( 0.5f + (float)(dt) / intervalPerTick ) )
	...
	{
		return *(float*)((DWORD)this + GET_NETVAR("DT_CSPlayer", "m_flFlashDuration"));
	}
	...
	*/
	...
	int* GetItemDefinitionIndex() // if not working please delete
	{
